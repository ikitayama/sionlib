...
_sion_generic_apidesc * _lsion_generic_alloc_apidesc(void) {
  ...
  if (sion_apidesc == NULL) {
    _lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"cannot allocate apidescriptor structure of size %lu (sion_apidesc), aborting ...\n", (unsigned long) sizeof(_sion_generic_apidesc));
    return(NULL);
  }
...
int _lsion_generic_init_apidesc(_sion_generic_apidesc *sion_apidesc)
{
  ...
  if (sion_apidesc == NULL) {
    return(_lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"_lsion_generic_init_apidesc: cannot initalized, data structure is not allocated, aborting ...\n"));
  }
  sion_apidesc->aid = -1;
...
int _lsion_generic_free_apidesc(_sion_generic_apidesc *sion_apidesc)
{
  ...
  if (sion_apidesc == NULL) {
    return(_lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"_lsion_generic_free_apidesc: cannot free, data structure is not allocated, aborting ...\n"));
  }
...
_sion_generic_gendata * _lsion_generic_alloc_gendata(void) {
  ...
  if (sion_gendata == NULL) {
    _lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"cannot allocate gendata structure of size %lu (sion_gendata), aborting ...\n", (unsigned long) sizeof(_sion_generic_gendata));
    return(NULL);
  }
...
int _lsion_generic_init_gendata(_sion_generic_gendata *sion_gendata)
{
  ...
  if (sion_gendata == NULL) {
    return(_lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"_lsion_generic_init_gendata: cannot initalized, data structure is not allocated, aborting ...\n"));
  }
...
int _lsion_generic_free_gendata(_sion_generic_gendata *sion_gendata)
{
  ...
  if (sion_gendata == NULL) {
    return(_lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"_lsion_generic_free_gendata: cannot free, data structure is not allocated, aborting ...\n"));
  }
  free(sion_gendata);
 ...
 * @retval      SION_SUCCESS if OK
 */
int _lsion_generic_update_api_level(_sion_generic_apidesc *sion_apidesc)
{

  int       rc = SION_SUCCESS;

  if (sion_apidesc == NULL) {
    return(_lsion_errorprint(SION_NOT_SUCCESS,_SION_ERROR_RETURN,"_lsion_generic_update_api_level: cannot update data structure, it is not allocated, aborting ...\n"));
  }
