...
int _lsion_print_collstat( _sion_collstat *sion_collstat, _sion_filedesc *sion_filedesc );
int _lsion_destroy_collstat( _sion_collstat *sion_collstat );
int _lsion_debugprint_collstat( _sion_collstat *collstat, _sion_filedesc *sion_filedesc );
