...
#define SION_ABSOLUTE_POS        -104  /*!< Alias for the flag to specify in lsion_seek an absolute position in bytestream */
#define SION_END_POS             -105  /*!< Flag in lsion_seek for a position relative to end */
...
/* role of task, for lsion_get_io_info  */
