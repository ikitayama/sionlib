 ...
 */
int  _lsion_apply_hint_gpfs_access_range(int fd, long long  start, long long length, int iswrite ) {
  int rc=SION_SUCCESS;
 ...
 * @return SION_SUCCESS if ok
 */
int  _lsion_apply_hint_gpfs_free_range(int fd, long long  start, long long length, int iswrite ) {
  int rc=SION_SUCCESS;
