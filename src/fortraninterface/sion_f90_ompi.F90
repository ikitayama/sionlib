...
! Subroutines (without overloading)
  subroutine lfsion_paropen_ompi(fname,file_mode,nfiles,fgComm,flComm,chunksizes,&
 &                              fsblksize,globalranks,newfname,sid)
    ...
    call lfsion_paropen_ompi_c(fname,file_mode,nfiles,fgComm,flComm,chunksizes,&
 &                            fsblksize,globalranks,newfname,sid)
  end subroutine lfsion_paropen_ompi
  ...
  end subroutine lfsion_parclose_ompi
