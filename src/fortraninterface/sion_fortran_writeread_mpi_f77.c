...
#include "sion_fortran_writeread_mpi_f77.h"

#include "sion_mpi.h"

#define DFUNCTION "lfsion_coll_fwrite_mpi"
/*!
			   ...
			   sion_int64 *rc)
{
  ...
  (*rc) = (sion_int64) lsion_coll_fwrite_mpi(data, (size_t) *size, (size_t) *nitems, *sid);
...
void lfsion_coll_fread_mpi(void *data, 
			  ...
			  sion_int64 *rc)
{
  (*rc) = (sion_int64) lsion_coll_fread_mpi(data, (size_t) *size, (size_t) *nitems, *sid);
}
