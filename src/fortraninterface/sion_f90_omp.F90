...
! Subroutines (without overloading)
  subroutine lfsion_paropen_omp(fname,file_mode,chunksizes,fsblksize,globalranks,newfname,sid)
    ...
    call lfsion_paropen_omp_c(fname,file_mode,chunksizes,fsblksize,globalranks,newfname,sid)
  end subroutine lfsion_paropen_omp

  subroutine lfsion_parclose_omp(sid,ierr)
    ...
    call lfsion_parclose_omp_c(sid,ierr)
  end subroutine lfsion_parclose_omp
