...
(
  ...
  export LSION_DEBUG_MASK=4095
#  export LSION_DEBUG_RANK1=0
#  export LSION_DEBUG_RANK2=3
  export LSION_ERROR_MSG_RANK=0
  export LSION_DEBUG_SILENT=1
  export LSION_COLLDEBUG=3
  
  # TEST 1

  export LSION_DEBUG=test1_${TESTNAME}
  export OMP_NUM_THREADS=4
  export LSION_COLLSIZE=2
  ...
  export LSION_DEBUG=siondump1_${TESTNAME}
  ...
  export LSION_DEBUG=test2_${TESTNAME}
  ...
  export LSION_DEBUG=siondump2_${TESTNAME}
