...
(
  ...
  export LSION_HINTS=1
  export LSION_HINT_TYPE_LINUX=1
  echo "on rank 0 starting Test with SION_HINT_TYPE_LINUX" > stdout.log
  echo "on rank 0 starting Test with SION_HINT_TYPE_LINUX" > stderr.log
