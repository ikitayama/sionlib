...
(
  ...
  export LSION_BUFFERSIZE=-1
  echo "on rank 0 starting Test with SION_BUFFERSIZE=$LSION_BUFFERSIZE" > stdout.log
  echo "on rank 0 starting Test with SION_BUFFERSIZE=$LSION_BUFFERSIZE" > stderr.log
