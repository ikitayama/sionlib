...
(
  ...
  export LSION_CACHESIZE=1048576
  echo "on rank 0 starting Test with SION_CACHESIZE=$LSION_CACHESIZE" > stdout.log
  echo "on rank 0 starting Test with SION_CACHESIZE=$LSION_CACHESIZE" > stderr.log
