...
int main() {
   {
    ...
    sionlib::serial::LSIONFile f(fname);
  ...
  // ----------------------------------
   if(0) {
    ...
    sionlib::serial::LSIONFile f2(fname2);
    //    cout << "Test" << endl;
...
#define BUFSIZE 10000  
    ...
    sionlib::serial::LSIONFile f3(fname3);
  ...
  if(0) {
    ...
    sionlib::serial::LSIONFile f4(fname4);
...
#define BUFSIZE 10000  
  ...
  /* ------------------------------------- */
   if(0)  {
    ...
    sionlib::serial::LSIONFile f5(fname5);
    int ntasks = 1;
